...
const purchaseItems = Array.from({ length: 300 }, (_, index) => ({
...
describe("采购工作区渲染性能回归", () => {
  it("300条采购数据下连续30次分类切换的平均Profiler更新成本低于16ms", async () => {
    ...
    console.info(`[store-purchase-benchmark] updates=${updates.length} averageDurationMs=${averageDuration.toFixed(3)}`);
