...
export const FEATURE_CONTRACTS = [
  ...
  // 鸡尾酒内容与研发
  defineFeatureContract({ id: "recipes.workspace", label: "配方库", resource: "recipes", actions: { open: "recipes.view", edit: "recipes.edit", import: "recipes.import", manage: "recipes.manage" }, sync: "shared", storageKeys: ["cocktail.recipes", "cocktail.categories", "cocktail.tags", "cocktail.tagGroups", "cocktail.categoryGroups", "cocktail.seeded", "cocktail_waldorf_imported_v1"], offline: { ...cachedEditable, requiresOnlineActions: ["import"] } }),
  defineFeatureContract({ id: "bottles.workspace", label: "酒款库", resource: "bottles", actions: { open: "bottles.view", edit: "bottles.edit", import: "bottles.import", manage: "bottles.manage" }, sync: "shared", storageKeys: ["cocktail.bottles", "cocktail.bottles.seeded", "cocktail.bottles.waldorf.v1", "bottles.taxonomy.categories.v1", "bottles.taxonomy.styles.v1"], offline: { ...cachedEditable, requiresOnlineActions: ["import"] } }),
  defineFeatureContract({ id: "homemade.workspace", label: "自制品", resource: "homemade", actions: { open: "homemade.view", edit: "homemade.edit", import: "homemade.import", manage: "homemade.manage" }, sync: "shared", storageKeys: ["homemade.preps.v1", "homemade.seeded.v1", "homemade.sections.v1", "homemade.types.v1", "homemade.taxonomy.v2", "homemade.waldorf.v1", "homemade.waldorf.v2", "homemade.source.v3"], offline: { ...cachedEditable, requiresOnlineActions: ["import"] } }),
  ...
  defineFeatureContract({ id: "shopping.workspace", label: "采购清单", resource: "shopping", actions: { open: "shopping.view", edit: "shopping.edit" }, sync: "shared", storageKeys: ["shopping_store_v1"], offline: cachedEditable }),
  ...
  defineFeatureContract({ id: "wine.inventory", label: "葡萄酒工作台", resource: "inventory_wine", actions: { open: "inventory_wine.view", edit: "inventory_wine.edit", import: "inventory_wine.import", export: "inventory_wine.export", close: "inventory_wine.close" }, sync: "shared", storageKeys: ["wine.snapshots.v2", "wine.manual_purchases.v1"], offline: { ...cachedEditable, requiresOnlineActions: ["import", "export", "close"] } }),
