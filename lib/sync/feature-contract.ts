...
export const FEATURE_CONTRACTS = [
  ...
  defineFeatureContract({ id: "bottles.workspace", label: "酒款库", resource: "bottles", actions: { open: "bottles.view", edit: "bottles.edit", import: "bottles.import", manage: "bottles.manage" }, sync: "shared", storageKeys: ["cocktail.bottles", "cocktail.bottles.seeded", "bottles.taxonomy.categories.v1", "bottles.taxonomy.styles.v1"], offline: { ...cachedEditable, requiresOnlineActions: ["import"] } }),
