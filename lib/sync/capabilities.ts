...
export const STORAGE_POLICY: Readonly<Record<SyncStorageKey, StorageCapabilityPolicy>> = {
  ...
  "store.purchase.v1": policy("shopping.view", "shopping.edit"),
  ...
  "wine.import_control.v1": policy("inventory_wine.view", "inventory_wine.import"),
  "wine.master_data.v1": policy("inventory_wine.view", "inventory_wine.edit"),
  ...
  "module_month_close_archives_v1": policy("reports_monthly.view", "reports_monthly.close"),
  "module_month_adjustment_sessions_v1": policy("reports_monthly.view", "reports_monthly.edit"),
  ...
  "labor.separate_payments.v1": policy("payroll.view", "payroll.edit"),
