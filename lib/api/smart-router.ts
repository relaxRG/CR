...
export async function bulkImportExtract(params: { text?: string; imageBase64?: string; imageMime?: string; fileBase64?: string; fileName?: string }) {
  return callAI<{
    items: Array<{
...
export async function enrichBottles(params: { names: string[] }) {
  return callAI<{
    items: Array<{
