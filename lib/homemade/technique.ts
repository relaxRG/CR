...
export const TECHNIQUES: Technique[] = [
  ...
  },
  {
    ...
    descZh: "超声波空化效应加速细胞壁破裂,数分钟内完成传统数天的萃取量,适合坚硬香料与木质原料。",
    descEn: "Cavitation from ultrasonic waves ruptures cell walls in minutes, matching days of traditional maceration.",
    keywords: ["超声波", "超声萃取", "ultrasonic", "sonication", "ultrasound extract"],
    tier: 0,
  },
  {
    key: "enzyme_pectinase",
    zh: "果胶酶澄清",
    en: "Enzyme Clarification (Pectinase)",
    descZh: "果胶酶分解果汁中的果胶链,使浑浊颗粒聚集沉降,得到晶莹果汁且不损失风味。",
    descEn: "Pectinase breaks pectin chains in juice, causing haze particles to aggregate and settle for crystal clarity.",
    keywords: ["果胶酶", "pectinase", "enzyme clarif", "酶澄清"],
    tier: 0,
  },
  {
    key: "enzyme_amylase",
    zh: "淀粉酶处理",
    en: "Amylase Treatment",
    descZh: "淀粉酶将淀粉链水解为糖,用于谷物/根茎类原料的糖化前处理。",
    descEn: "Amylase hydrolyzes starch into fermentable sugars; used for grain/root saccharification.",
    keywords: ["淀粉酶", "amylase", "糖化", "saccharif"],
    tier: 0,
  },
  {
    key: "spherification",
    zh: "球化",
    en: "Spherification",
    descZh: "海藻酸钠与钙离子反应形成薄膜包裹液体,制作爆浆球形装饰或鸡尾酒球。",
    descEn: "Sodium alginate reacts with calcium to form a membrane encapsulating liquid into caviar pearls or spheres.",
    keywords: ["球化", "spherif", "alginate", "海藻酸", "caviar pearl", "爆浆球"],
    tier: 0,
  },
  {
    key: "emulsification",
    zh: "乳化",
    en: "Emulsification",
    descZh: "卵磷脂等乳化剂使油水相稳定混合,制作空气泡沫或乳化利口酒。",
    descEn: "Lecithin or other emulsifiers stabilize oil-water mixtures for foams or emulsified liqueurs.",
    keywords: ["乳化", "lecithin", "卵磷脂", "emulsif", "泡沫乳化"],
    tier: 0,
  },
  {
    key: "liquid_nitrogen",
    zh: "液氮冷冻",
    en: "Liquid Nitrogen",
    descZh: "液氮(-196°C)瞬间冷冻食材或制作冰淇淋/雪葩,同时可制造烟雾视觉效果。",
    descEn: "Liquid nitrogen (-196°C) flash-freezes ingredients or creates ice cream/sorbet with dramatic fog effects.",
    keywords: ["液氮", "liquid nitrogen", "ln2", "flash freeze", "瞬间冷冻"],
    tier: 0,
  },
  {
    key: "steam_distill",
    ...
    descZh: "水蒸气携带植物精油蒸馏,制作花露水/草本蒸馏液,保留娇嫩花香。",
    descEn: "Steam carries essential oils through distillation to create hydrosols and botanical distillates.",
    keywords: ["蒸汽蒸馏", "蒸馏水", "花露水", "hydrosol", "steam distill", "botanical distillate"],
    tier: 0,
  },
  {
    key: "bottle_age",
    zh: "瓶陈",
    en: "Bottle Aging",
    descZh: "预调鸡尾酒密封瓶中陈放,酯化反应使风味融合圆润,数周至数月。",
    descEn: "Esterification in sealed bottles harmonizes flavors over weeks to months.",
    keywords: ["瓶陈", "bottle age", "bottle-age", "bottled cocktail aging"],
    tier: 0,
  },
  {
    key: "oak_stave",
    zh: "橡木片陈化",
    en: "Oak Stave / Chip Aging",
    descZh: "橡木片/橡木螺旋浸入液体,快速赋予木质香草香,无需整桶。",
    descEn: "Oak staves or spirals submerged in liquid impart wood and vanilla notes without a full barrel.",
    keywords: ["橡木片", "橡木螺旋", "oak stave", "oak chip", "oak spiral", "oak stick"],
    tier: 0,
  },
  {
    key: "carbonation",
