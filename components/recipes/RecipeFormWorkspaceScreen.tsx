...
import { MOBILE_NESTABLE_DRAGGABLE_LIST_PROPS } from "@/components/performance/mobile-virtual-list";
...
export default function RecipeFormScreen() {
  ...
  const [, setDurationUserOverride] = useState(!!(editing?.drinkDuration));
  const [, setOccasionUserOverride] = useState(!!(editing?.occasion));
